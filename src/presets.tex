...
\clearpage
\textbf{Lines 1189-1231. \icode{\textbf{presetValueArray\index{presetValueArray}}}}
...
\textbf{Lines 1189-1231. \icode{\textbf{presetValueArray\index{presetValueArray}}}:} Let's start at the end. This is where the values stored in the preset
...
\clearpage
\textbf{Lines 1189-1231. \icode{\textbf{DisplayPresetMessage\index{DisplayPresetMessage}}}} 
\begin{lstlisting}[escapechar=\%]
;-------------------------------------------------------
...
\textbf{Lines 1189-1231. \icode{\textbf{DisplayPresetMessage\index{DisplayPresetMessage}}}:} Our objective here is modest enough. Display something like the following
...
\clearpage
\textbf{Lines 1189-1231. \icode{\textbf{UpdateCurrentActivePreset\index{UpdateCurrentActivePreset}}}} 
\begin{lstlisting}[escapechar=\%]
;-------------------------------------------------------
...
\textbf{Lines 1189-1231. \icode{\textbf{UpdateCurrentActivePreset\index{UpdateCurrentActivePreset}}}:} In the current path we're following (the one where we load a selected preset)
...
\clearpage
\textbf{Lines 1189-1231. \icode{\textbf{RefreshPresetData\index{RefreshPresetData}}}} 
\begin{lstlisting}[escapechar=\%]
...
\textbf{Lines 1189-1231. \icode{\textbf{RefreshPresetData\index{RefreshPresetData}}}:} Our first order of business here is to get the location of the selected preset
...
\textbf{Lines 1189-1231. \icode{\textbf{LoadSelectedPresetSequence\index{LoadSelectedPresetSequence}}}} 
\begin{lstlisting}[escapechar=\%]
...
\end{lstlisting}
\clearpage
\textbf{Lines 1189-1231. \icode{\textbf{LoadSelectedPresetSequence\index{LoadSelectedPresetSequence}}}:} After all this trouble we go ahead and load the data using our pointers into 
