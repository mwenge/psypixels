...
The next time C64 paints a row of the screen with the contents of character '\icode{\$63}' it will use this updated definition to do so and create the 
...
in a familiar form: a routine called \icode{PaintStructureAtCurrentPosition} supported by two helpers called \icode{PaintPixelForCurrentSymmetry}
and \icode{PaintPixel}.
