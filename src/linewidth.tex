...
\clearpage
\textbf{Lines 1189-1231. \icode{\textbf{JustLPressed\index{JustLPressed}}}} 
...
\end{lstlisting}
\clearpage
\textbf{Lines 1189-1231. \icode{\textbf{ApplyLineMode}}:} Here \icode{lineModeActivated\index{lineModeActivated}} is used
...
\textbf{Lines 1189-1231. \icode{\textbf{MainPaintLoop\index{MainPaintLoop}}}:} For now, in the main paint loop, when it comes time to do some
...
\clearpage
\textbf{Lines 1189-1231. \icode{\textbf{PaintLineMode\index{PaintLineMode}}}} 
...
\textbf{Lines 1189-1231. \icode{\textbf{PaintLineMode\index{PaintLineMode}}}:} 'Line Mode' painting, as we've already mentioned,
