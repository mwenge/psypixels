...
\clearpage
\textbf{Lines 82-113. \icode{\textbf{InitializeProgram}}}
...
\textbf{Lines 321-327. \icode{\textbf{PutRandomByteInAccumulator}}}
...
PutRandomByteInAccumulator   
        ...
        RTS 
\end{lstlisting}
\textbf{Lines 434-445. \icode{\textbf{ReinitializeSequences}}}
...
\rhead[]{\icode{starOneXPosArray/starOneYPosArray}}
...
\icode{\$00}.
\clearpage
\textbf{Lines 385-429. \icode{\textbf{pixelXPositionArray}}}
...
\clearpage
\textbf{Lines 450-482. \icode{\textbf{LaunchPsychedelia}}}
...
\clearpage
\textbf{Lines 217-285. \icode{\textbf{PaintStructureAtCurrentPosition}}}
...
\rhead[]{\icode{PaintStructureAtCurrentPosition: LineReadLoop}}
...
\clearpage
\textbf{Lines 332-382. \icode{\textbf{PaintPixelForCurrentSymmetry}}}
...
\clearpage
\textbf{Lines 164-214. \icode{\textbf{PaintPixel}}}
...
\clearpage
\textbf{Lines 300-313. \icode{\textbf{CheckIfPlayerPressedFire}}}
...
\clearpage
\textbf{Lines 300-313. \icode{\textbf{DrawCursorAndReturnFromInterrupt}}}
...
\bigskip
\textbf{Lines 300-313. \icode{\textbf{LoadXAndYOfCursorPosition}}}
...
\end{lstlisting}
\bigskip
\textbf{Lines 300-313. \icode{\textbf{PaintCursorAtCurrentPosition}}}
...
\rhead[]{\icode{DrawCursorAndReturnFromInterrupt}}
\textbf{Lines 300-313. \icode{\textbf{DrawCursorAndReturnFromInterrupt}}:} Drawing the cursor should be a relatively simple matter
of converting the cursor position stored in \icode{cursorXPosition} and \icode{cursorYPosition} to a position on the screen. Again
...
The real work is clearly done by our two helper routines \icode{LoadXAndYOfCursorPosition} and \icode{PaintCursorAtCurrentPosition}. 

Let's imagine our cursor has an \icode{cursorYPosition} of 5 and an \icode{cursorXPosition} of 10. This means in \icode{LoadXAndYOfCursorPosition}
we will retrieve the elements with index 5 in \icode{colorRAMLineTableLoPtrArray} and \icode{colorRAMLineTableHiPtrArray}. So consulting
...
With an address of \icode{\$D8C8} we now know where in Color RAM our line starts. We can now load our \icode{cursorXPosition} to the
\icode{Y} register:
\begin{lstlisting}
        LDY cursorXPosition
\end{lstlisting}
