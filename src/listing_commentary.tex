...
\end{lstlisting}
\clearpage
\textbf{Lines 300-313. \icode{\textbf{PlayerHasPressedRight}}:} As in the previous page, here we're checking for left/right
movement in the joystick and updating the \icode{cursorXPosition} if required.
...
\textbf{Lines 300-313. \icode{\textbf{CheckIfPlayerPressedFire}}:} This entire routine could be 
