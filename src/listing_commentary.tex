...
This doesn't have a proper name of it's own so we will call it \icode{DEFAULT\_IRQ\_HANDLER}.
...
\textbf{Lines 491-506. \icode{\textbf{MainInterruptHandler}}:} What is an Interrupt Handler when it's at home and why are
