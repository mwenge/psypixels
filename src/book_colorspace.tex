...
% KANJIS!
% Removed to allow bold font to work again ¯\_(ツ)_/¯
%\usepackage{CJKutf8}
...
\begin{document}    
\ifx\forprint\undefined
\includepdf{\base/illu/cover_front_colorspace.pdf}
\else
\blankpage
\blankpage
\fi

\subfile{src/copyright_colorspace}
...
\ifx\forprint\undefined
   \includepdf{\base/illu/cover_back_colorspace.pdf}
\else
