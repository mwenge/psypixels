...
\clearpage
\textbf{Lines 1189-1231. \icode{\textbf{MaybeQPressed\index{MaybeQPressed}}}}
...
\end{lstlisting}
\textbf{Lines 1189-1231. \icode{\textbf{ActivateSequencer\index{ActivateSequencer}}}}
\begin{lstlisting}[escapechar=\%]
...
\textbf{Lines 1189-1231. \icode{\textbf{ActivateSequencer\index{ActivateSequencer}}}:}  Despite its heady name, this routine just sets a couple of variables.
...
\clearpage
\textbf{Lines 1189-1231. \icode{\textbf{LoadDataForSequencer\index{LoadDataForSequencer}}}}
\begin{lstlisting}[escapechar=\%]
...
\textbf{Lines 1189-1231. \icode{\textbf{LoadDataForSequencer\index{LoadDataForSequencer}}}:} We've already seen a version of this movie before. When we loaded the burst data in the previous chapter
...
\clearpage
\textbf{Lines 1189-1231. \icode{\textbf{LoadDataForSequencer\index{LoadDataForSequencer}}}} continued.
\begin{lstlisting}[escapechar=\%]
...
\textbf{Lines 1189-1231. \icode{\textbf{MoveToNextPositionInSequencer\index{MoveToNextPositionInSequencer}}}:}  Now that we've loaded a step of sequence data we can repoint our pointer and get out of here. 
