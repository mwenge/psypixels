...
\includegraphics[width=1.3cm]{src/patterns/pixels/pixel_pattern0_25.png}%
\includegraphics[width=1.3cm]{src/patterns/pixels/pixel_pattern0_26.png}%
\includegraphics[width=1.3cm]{src/patterns/pixels/pixel_pattern0_27.png}%
} \\
        \midrule
